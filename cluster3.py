...
consumer = KafkaConsumer(
    'cluster3',  # Consume from 'cluster1'
...
for message in consumer:
    ...
    print(f"Received from cluster3: {emoji_data}")

    # Send the same message to 'sub1', 'sub2', and 'sub3'
    producer.send('sub9', value=emoji_data)
    producer.send('sub7', value=emoji_data)
    producer.send('sub8', value=emoji_data)

    print(f"Sent data to sub7, sub8, and sub9: {emoji_data}")
