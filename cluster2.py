...
consumer = KafkaConsumer(
    'cluster2',  # Consume from 'cluster1'
...
for message in consumer:
    ...
    print(f"Received from cluster2: {emoji_data}")

    # Send the same message to 'sub1', 'sub2', and 'sub3'
    producer.send('sub4', value=emoji_data)
    producer.send('sub5', value=emoji_data)
    producer.send('sub6', value=emoji_data)

    print(f"Sent data to sub4, sub5, and sub6: {emoji_data}")
